...
class Archive(Base):
    ...
    - relative: 至亲记忆
    - celebrity: 伟人/名人记忆
    - nation: 国家/历史记忆（可作非遗等国家主题）；著录发源地/名录层级等挂在各「成员 / 记忆实体」上
    
    「国家历史」类型可在各记忆实体上扩展著录发源地与流传地域、名录层级、列入年份等（参考 UNESCO 名录字段口径）。
    """
...
class Member(Base):
    ...
    # 国家记忆 / 非遗等：发源地与流传地域、名录层级、列入年份；亦可用于历史人物等非非遗主题的著录口吻
