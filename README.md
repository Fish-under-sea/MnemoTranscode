...
MTC（MnemoTranscode — Memory To Code）是一个通用的 **AI 关系档案与生命故事平台**。它不只服务于家族记忆，可以承载恋人、挚友、至亲、伟人乃至一个国家/民族的历史记忆。
...
| 功能模块 | 说明 |
|---------|------|
| **关系档案库** | 创建家族、恋人、挚友、至亲、伟人等多类型档案，管理档案内成员信息 |
...
| **语音克隆（规划）** | TTS + 声纹迁移，基于 CosyVoice 还原亲人声音 |
